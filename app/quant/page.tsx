...
export default function QuantReport() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black p-8 font-sans">
      <div className="max-w-4xl mx-auto pt-20 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        {/* Header */}
        <div className="p-6 md:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-0">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-zinc-900 dark:text-zinc-100 leading-tight">Quantitative Research Report</h1>
            <p className="text-zinc-600 dark:text-zinc-400 mt-1">Candidate: Ayush — Quantitative Analyst</p>
            <p className="text-sm text-zinc-500 mt-1">Analyst: Ayush • Date: {new Date().toLocaleDateString()}</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-right">
              <div className="text-xs text-zinc-500 dark:text-zinc-400">Fit Score</div>
              <div className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">8.7 / 10</div>
            </div>
          </div>
        </div>

        {/* Summary + Key metrics */}
        <div className="p-6 md:p-8 border-t border-zinc-200 dark:border-zinc-800 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-4">
            <section>
              <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Executive Summary</h2>
            ...
            <section className="mt-4">
              <h3 className="text-sm text-zinc-500 dark:text-zinc-400 uppercase tracking-wide">Hiring (Thesis)</h3>
          ...
          <aside className="bg-zinc-50 dark:bg-zinc-800 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-xs text-zinc-500 dark:text-zinc-400">Recent Performance</div>
                <div className="text-sm text-zinc-900 dark:text-zinc-100 font-medium">Signal Quality (last 30 days)</div>
              </div>
            ...
            <div className="mt-4 space-y-2">
              {metrics.map((m, idx) => (
                <div key={idx} className="flex justify-between text-sm">
                  <div className="text-zinc-500 dark:text-zinc-400">{m.k}</div>
                  <div className="font-medium text-zinc-900 dark:text-zinc-100">{m.v}</div>
                </div>
              ))}
            </div>
          </aside>
        ...
        {/* Report body */}
        <div className="p-6 md:p-8 space-y-8 border-t border-zinc-200 dark:border-zinc-800">
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Detailed Assessment</h2>
            <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 text-zinc-600 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="bg-zinc-50 dark:bg-zinc-800 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700">
                <div className="text-sm text-zinc-500 dark:text-zinc-400">Quant Scores</div>
                <div className="mt-3 space-y-2">
                  <div className="flex justify-between text-zinc-600 dark:text-zinc-400"><span className="">Research</span><span className="font-semibold text-zinc-900 dark:text-zinc-100">8.8</span></div>
                  <div className="flex justify-between text-zinc-600 dark:text-zinc-400"><span className="">Engineering</span><span className="font-semibold text-zinc-900 dark:text-zinc-100">8.4</span></div>
                  <div className="flex justify-between text-zinc-600 dark:text-zinc-400"><span className="">Product Sense</span><span className="font-semibold text-zinc-900 dark:text-zinc-100">8.0</span></div>
                  <div className="flex justify-between text-zinc-600 dark:text-zinc-400"><span className="">Execution</span><span className="font-semibold text-zinc-900 dark:text-zinc-100">8.6</span></div>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Risk & Mitigants</h2>
            <ul className="list-disc pl-5 mt-3 text-zinc-600 dark:text-zinc-400 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Hiring Recommendation Rationale</h2>
            <p className="text-zinc-600 dark:text-zinc-400 mt-3">
              Recommendation: <span className="font-semibold text-zinc-900 dark:text-zinc-100">{recommendation}</span>. The candidate demonstrates strong analytical ability, robust coding practices, and a good balance between research rigour and engineering pragmatism. Their skill set maps well to quantitative research and prototyping roles with a clear path to production ownership.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Next Steps</h2>
            <ol className="list-decimal pl-5 mt-3 text-zinc-600 dark:text-zinc-400 space-y-2">
        ...
        {/* Footer */}
        <div className="p-4 bg-zinc-100 dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800 text-sm text-zinc-500 flex justify-between items-center">
