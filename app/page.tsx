        ...
        <SectionContainer variant="narrow">
          <section className="flex flex-col gap-10 text-center sm:text-left">
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-sm font-medium tracking-wide text-zinc-500 dark:text-zinc-400">
                · AI/ML Engineer · Full Stack Developer · Quant
              </h2>
            ...
            <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
              I design and build data-driven systems spanning applied machine
              learning, quantitative finance, scalable software.
            </p>
              ...
              <div className="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-black">
                ...
                <div className="mb-2">
                  ...
                  <p className="text-xs text-zinc-500">
                    Department of Data Science and AI, IIT Madras · Jan 2025 —
                    Present
                  </p>
                </div>
            ...
            <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5 dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <p className="text-xs text-zinc-500">
                Sudha Gopalakrishnan Brain Centre, IIT Madras · Jul 2024 — Dec
                2025
              </p>
              <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                Contributed to the DHARANI project and built scalable systems,
                internal platforms, and AI pipelines used in production.
              </p>
              {/* Links */}
            ...
            <div className="flex justify-center sm:justify-start">
              <a
                href="/resume.pdf"
                download
                className="group inline-flex items-center gap-2 rounded-full bg-zinc-900 px-6 py-3 text-sm font-medium text-zinc-50 shadow-lg transition-all hover:bg-zinc-800 hover:shadow-xl active:scale-95 dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-white"
              >
                <svg
                  viewBox="0 0 24 24"
                  className="h-4 w-4 fill-current transition-transform group-hover:translate-y-0.5"
